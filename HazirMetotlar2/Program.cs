...
namespace MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine(Math.Pow(3,4));  //3 üzeri 4 ü verir.81
            System.Console.WriteLine(Math.Sqrt(9));  //Karekök alır. 3
            System.Console.WriteLine(Math.Log(9));  //9un e tabandaki logoritmik karşılıgı
            System.Console.WriteLine(Math.Exp(3)); //e üzeri 3 ü verir
            System.Console.WriteLine(Math.Log10(10)); // 10 sayısının logaritması 10 tabanındaki karsılıgı
